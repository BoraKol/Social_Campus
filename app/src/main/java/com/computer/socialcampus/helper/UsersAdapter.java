...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.ViewHolder>{
    ...
    public UsersAdapter(ArrayList<LoggedInUser> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        LoggedInUser users = list.get(position);
        Picasso.get().load(users.getPic()).placeholder(R.drawable.avatar3).into(holder.image);
